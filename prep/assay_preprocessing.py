...
df['Assay_Text'] = df['Assay'].apply(extract_text_from_html)

# 새로운 컬럼을 CSV 파일로 저장
df.to_csv('/Users/dain/PycharmProjects/Fall_2023/2023Fall_P4DS/output/assay_text_preprocessing.csv', index=False)
